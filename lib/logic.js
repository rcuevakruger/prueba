    ...
    */
    ...
    async function traspaso(traspaso) {
        ...
        traspaso.antiguoDueno.balance -= traspaso.nuevoDueno.balance;

    // Actualizar registro de activo
        let assetRegistry = await getAssetRegistry('com.cams.activo');
        await assetRegistry.update(traspaso.Activo)

    // Actualizar registro de usuario
        assetRegistry = await getAssetRegistry('com.cams.usuario');
        await assetRegistry.update(traspaso.nuevoDueno)
    }