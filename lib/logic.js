    ...
    */
    ...
    async function traspaso(traspaso) {
        ...
        traspaso.Activo.propietario = traspaso.nuevoDueno;
        traspaso.nuevoDueno.balance -= traspaso.Activo.valorActivo;
        traspaso.antiguoDueno.balance += traspaso.Activo.valorActivo;
    ...
    // Actualizar registro de usuario
        const userRegistry = await getParticipantRegistry('com.cams.usuario');
        await userRegistry.update(traspaso.nuevoDueno)
        await userRegistry.update(traspaso.antiguoDueno)
    }
